...
logDir=/Users/${username}/Documents/workplace/xcodebuild
mkdir -pv $logDir
...
rm -rf ./build
buildAppToDir=/Users/${username}/Documents/workplace/build/$projectName #编译打包完成后.archive .ipa文件存放的目录
...
mv $plistDir /Users/${username}/Sites/dacai/1/iphone/640/debug/app.plist
cd /Users/dacaiguo/Sites/dacai/1
svn st >/Users/dacaiguo/Sites/dacai/d.txt
svn add svn2.sh
svn commit -m 'add svn2.sh'
svn st >>/Users/dacaiguo/Sites/dacai/d.txt
...
cat << EOF > $htmlDir
      ...
      <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body> 
          ...
          <ul>    
            <li><h2><a href="itms-services://?action=download-manifest&amp;url=url=https://dacai.sinaapp.com/iphone/630/debug/app.plist">手机安装$appName(V$bundleVersion.$bundleBuildVersion)</a></h2></li>
